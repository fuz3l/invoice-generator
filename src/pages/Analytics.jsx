    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Analytics Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                ...
                <p className="text-lg sm:text-2xl font-bold text-gray-800">{totalInvoices}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Unique Customers</p>
                <p className="text-lg sm:text-2xl font-bold text-gray-800">{uniqueCustomers}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Avg. Invoice Value</p>
                <p className="text-lg sm:text-2xl font-bold text-gray-800">₹{avgInvoiceValue.toFixed(2)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
          {/* Sales Graph */}
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4">Sales Trend</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {/* Top Customers */}
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4">Top Customers by Revenue</h3>
            <div className="h-64 sm:h-80">
          ...
          {/* Top Products */}
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4">Top Products by Revenue</h3>
            <div className="h-64 sm:h-80">
        ...
        {invoices.length === 0 && (
          <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 text-center">
            ...
            <a
              href="/dashboard"
              className="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md transition-colors text-sm sm:text-base"
            >
              Create Invoice
            </a>
          </div>
